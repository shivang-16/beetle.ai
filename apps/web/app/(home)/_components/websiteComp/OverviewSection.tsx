...
const OverviewSection = () => {
  return (
    <section className="py-14 md:px-6 max-w-[1563px] w-full mx-auto">
      ...
      <motion.div
        ...
        className="max-w-[1200px] aspect-[1280/832] mx-auto p-3 rounded-2xl mask-b-from-55% border border-input/30">
        <Image
