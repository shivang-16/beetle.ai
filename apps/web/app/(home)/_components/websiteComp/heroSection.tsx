  ...
  return (
    <section className="">
      <div className="relative z-10">
        {/* Hero Section */}
        <div className="max-w-[1563px] w-full mx-auto md:px-6 pt-[15%] md:pt-[7%]">
          <div className="relative z-10 font-geist-sans py-10 rounded-4xl flex h-[80svh]">
            <div
              className="absolute inset-0 z-0 mask-radial-[100%_100%] mask-radial-from-[5%] mask-radial-at-right md:rounded-4xl"
              style={{
            ...
            <div className="relative z-10 flex-2 pl-4 flex flex-col justify-between">
              <h1 className="text-5xl leading-tight font-inter font-medium text-white mb-6">
