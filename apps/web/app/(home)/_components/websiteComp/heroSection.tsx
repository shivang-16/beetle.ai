...
const heroSection = () => {
  return (
    <section className="px-5 border-b border-[#333333]">
      {/* Hero Section */}
      <div className="max-w-[1563px] w-full mx-auto md:px-6 pt-[15%] md:pt-[6%] pb-6 border border-t-0 border-b-0 border-[#333333]">
        <div className="relative z-10 font-geist-sans py-10 flex h-[80svh]">
          <div
          ...
          <div className="relative z-10 flex-2 px-4 md:pr-0 flex flex-col justify-between">
            <h1 className="text-4xl sm:text-5xl leading-tight font-inter font-medium text-white mb-6">
              <HeroTitle title="AI-Powered GitHub Insights — Analyze Smarter, Code Faster" />
            </h1>

            <div>
              <p className="text-xl md:text-2xl leading-tight text-white/80 mb-8">
                Unleash the power of AI to analyze your entire repository.
              ...
              <SignUpButton>
                <Button
                  ...
                  Get your repo analysis started <ArrowUpRight />
                </Button>
              </SignUpButton>
            </div>
          </div>
