...
const ParallaxBeetle = () => {
  ...
  return (
    <section className="fixed bottom-0 h-96 bg-primary w-full -z-10">
      <div className="absolute inset-0 flex items-center justify-center">
        <h1 className="text-[12rem] md:text-[22rem] lg:text-[22rem] xl:text-[27rem] font-black text-black/90 select-none leading-none tracking-tighter flex">
